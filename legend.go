...
import (
	"github.com/josuehennemann/go-chart/drawing"
)
...
// LegendLeft is a legend that is designed for longer series lists.
func LegendLeftPie(c *PieChart, userDefaults ...Style) Renderable {
	return func(r Renderer, cb Box, chartDefaults Style) {
		legendDefaults := Style{
			FillColor:   drawing.ColorWhite,
			FontColor:   DefaultTextColor,
...
// LegendLeft is a legend that is designed for longer series lists.
func LegendLeftDonut(c *DonutChart, userDefaults ...Style) Renderable {
	return func(r Renderer, cb Box, chartDefaults Style) {
		legendDefaults := Style{
			FillColor:   drawing.ColorWhite,
			FontColor:   DefaultTextColor,
